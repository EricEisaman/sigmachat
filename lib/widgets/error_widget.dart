...
class SigmaChatErrorWidget extends StatefulWidget {
  final FlutterErrorDetails details;
  const SigmaChatErrorWidget(this.details, {super.key});

  @override
  State<SigmaChatErrorWidget> createState() => _SigmaChatErrorWidgetState();
}

class _SigmaChatErrorWidgetState extends State<SigmaChatErrorWidget> {
