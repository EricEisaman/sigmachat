...
import 'package:sigmachat/pages/chat/chat_view.dart';
import 'package:sigmachat/pages/chat/event_info_dialog.dart';
import 'package:sigmachat/pages/chat/start_poll_bottom_sheet.dart';
...
import 'package:sigmachat/utils/matrix_sdk_extensions/event_extension.dart';
...
import 'package:sigmachat/utils/show_scaffold_dialog.dart';
import 'package:sigmachat/widgets/adaptive_dialogs/show_modal_action_popup.dart';
      ...
      children: [
        ...
        ValueListenableBuilder(
          ...
          builder: (context, displayChatDetailsColumn, _) =>
              !SigmaThemes.isThreeColumnMode(context) ||
                  room.membership != Membership.join ||
                  !displayChatDetailsColumn
              ? const SizedBox(height: double.infinity, width: 0)
              : Container(
                  width: SigmaThemes.columnWidth,
