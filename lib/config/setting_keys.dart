...
enum AppSettings<T> {
  ...
  showNoGoogle<bool>('chat.sigma.show_no_google', false),
  unifiedPushRegistered<bool>('chat.sigma.unifiedpush.registered', false),
  unifiedPushEndpoint<String>('chat.sigma.unifiedpush.endpoint', ''),
  ...
  renderHtml<bool>('chat.sigma.renderHtml', true),
  fontSizeFactor<double>('chat.sigma.font_size_factor', 1.0),
  hideRedactedEvents<bool>('chat.sigma.hideRedactedEvents', false),
  hideUnknownEvents<bool>('chat.sigma.hideUnknownEvents', true),
  autoplayImages<bool>('chat.sigma.autoplay_images', true),
  sendTypingNotifications<bool>('chat.sigma.send_typing_notifications', true),
  sendPublicReadReceipts<bool>('chat.sigma.send_public_read_receipts', true),
  swipeRightToLeftToReply<bool>('chat.sigma.swipeRightToLeftToReply', true),
  sendOnEnter<bool>('chat.sigma.send_on_enter', false),
  showPresences<bool>('chat.sigma.show_presences', true),
  displayNavigationRail<bool>('chat.sigma.display_navigation_rail', false),
  experimentalVoip<bool>('chat.sigma.experimental_voip', false),
  shareKeysWith<String>('chat.sigma.share_keys_with_2', 'all'),
  noEncryptionWarningShown<bool>(
    'chat.sigma.no_encryption_warning_shown',
    false,
  ),
  displayChatDetailsColumn('chat.sigma.display_chat_details_column', false),
  // AppConfig-mirrored settings
  applicationName<String>('chat.sigma.application_name', 'SigmaChat'),
  defaultHomeserver<String>('chat.sigma.default_homeserver', 'matrix.org'),
  // colorSchemeSeed stored as ARGB int
  colorSchemeSeedInt<int>('chat.sigma.color_scheme_seed', 0xFF5625BA),
  emojiSuggestionLocale<String>('emoji_suggestion_locale', ''),
  enableSoftLogout<bool>('chat.sigma.enable_soft_logout', false);
